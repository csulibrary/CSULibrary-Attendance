  ...
  <div class="page-shell flex h-screen bg-[#f0f4f1]">
    ...
    <div class="sr-main flex-1 p-4 lg:p-8 font-sans text-slate-700 overflow-y-auto">
        ...
        <div class="sr-header-container mx-auto flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
          ...
          <div>
            <div class="header-breadcrumb text-gray-400">
              <button class="back-btn flex items-center gap-1.5 text-gray-400 hover:text-[#0d2b0f] transition-colors"
      ...
      <main class="sr-grid mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <section class="lg:col-span-4 space-y-6">
          <div class="bg-white p-8 rounded-3xl border border-[#c2d4cb] shadow-xl shadow-slate-200/40">
            ...
            <div class="sr-filter-grid grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div class="relative">
                ...
                <button @click="isCollegeOpen = !isCollegeOpen; isProgramOpen = false" type="button"
                  ...
                  <i class="fas fa-chevron-down transition-transform shrink-0"
                    :class="{ 'rotate-180': isCollegeOpen }"></i>
                </button>
              ...
              <div class="relative">
                ...
                <button @click="isProgramOpen = !isProgramOpen; isCollegeOpen = false" type="button"
                  ...
                  <i class="fas fa-chevron-down transition-transform shrink-0"
                    :class="{ 'rotate-180': isProgramOpen }"></i>
                </button>
            ...
            <!-- STATUS -->
            <div>
              <label class="text-[10px] font-black uppercase text-[#4a7060] ml-1 mb-3 mt-5 block">Enrollment
                Status</label>
              <div class="grid gap-2">
                <button v-for="status in ['All', 'Enrolled', 'Withdrawn']" :key="status"
          ...
          <div class="bg-white rounded-3xl border border-[#c2d4cb] shadow-xl overflow-hidden">
            ...
            <div class="table-scroll overflow-y-auto max-h-[calc(100vh-300px)] overflow-x-auto pr-2">
              ...
              <div v-if="loadingStudents" class="py-20 flex justify-center">
                <p class="text-[#4a7060] text-xs font-bold">
                  Loading records... please wait, this might take a while.
                </p>
              </div>
    ...
    <Teleport to="body">
      ...
      <Transition name="backdrop">
        <div v-if="genderModalOpen" class="fixed inset-0 bg-black/30 backdrop-blur-sm z-40"
          @click="genderModalOpen = false" />
      </Transition>

      <!-- Drawer panel -->
      <Transition name="drawer">
        <div v-if="genderModalOpen"
          class="fixed top-0 right-0 h-full w-full max-w-125 bg-white z-50 shadow-2xl flex flex-col">

          <!-- Drawer Header -->
          <div class="px-8 py-6 border-b border-[#d4e4da] flex items-center justify-between shrink-0">
            <div>
            ...
            <div class="flex items-center gap-2">
              <!-- Refresh button -->
              <button @click="fetchAttendanceLogs(true)" :disabled="refreshing"
          ...
          <div class="flex-1 overflow-y-auto px-8 py-6 space-y-8 relative">
            ...
            <Transition name="backdrop">
              <div v-if="refreshing"
                ...
                <svg class="spin" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#0d2b0f"
                  stroke-width="2.5">
                  <path d="M23 4v6h-6" />
                  <path d="M1 20v-6h6" />
                  <path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15" />
            ...
            <div class="rounded-2xl bg-[#0d2b0f] p-6 text-white">
              <p class="text-[10px] font-black uppercase tracking-widest text-[#a8ccb8] mb-4">Overall Total — All
                Colleges</p>
              ...
              <div class="grid grid-cols-2 gap-3 mb-4">
                ...
                <div class="bg-white/10 rounded-xl px-4 py-3 flex items-center gap-3">
                  <div class="w-8 h-8 rounded-lg bg-[#4a7060]/30 flex items-center justify-center shrink-0">
                ...
                <!-- Male card -->
                <div class="bg-white/10 rounded-xl px-4 py-3 flex items-center gap-3">
                  <div class="w-8 h-8 rounded-lg bg-[#e6a800]/20 flex items-center justify-center shrink-0">
              ...
              <div class="flex justify-between mt-1.5 text-[10px] text-[#a8ccb8]">
                <span>{{ genderStats.total ? Math.round(genderStats.female / genderStats.total * 100) : 0 }}%
                  Female</span>
            ...
            <div>
              ...
              <div class="space-y-3">
                <div v-for="college in genderByCollege" :key="college.name"
                  ...
                  <button @click="toggleCollege(college.name)"
                    ...
                    <div class="flex items-center gap-3 shrink-0 mt-0.5">
                      ...
                      <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#4a7060" stroke-width="2.5"
                    ...
                    <div v-if="expandedColleges.has(college.name)" class="border-t border-[#d4e4da]">
                      <div class="px-5 py-4 bg-white">
                        ...
                        <div class="flex items-center gap-4 mb-3">
                          <p class="text-[10px] font-black uppercase tracking-widest text-[#4a7060] flex-1">By Year
                            Level</p>
                        ...
                        <div class="space-y-3">
                          <div v-for="yl in college.yearLevels" :key="yl.level"
                            ...
                            <div class="h-1.5 rounded-full bg-[#d4e4da] overflow-hidden flex">
                              <div class="h-full bg-[#4a7060] transition-all duration-500"
                                :style="{ width: yl.total ? (yl.female / yl.total * 100) + '%' : '0%' }" />
                              <div class="h-full bg-[#e6a800] transition-all duration-500"
...
const programs = computed(() => {
  const selectedCollege = filters.value.college
...
.table-scroll {
  scrollbar-color: #0d2b0f transparent;
}
